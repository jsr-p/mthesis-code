...
print(res)
write.csv(fe_res_table(res), file = "//nas1/XL2$/speciale/tables/fe_k50_all_all_deciles/eu_grad_k_all_w-INSTNR-all_ses_small_all_all.csv")
...
res <- summary(reg, vcov = ~INSTNR)
print(res)
write.csv(fe_res_table(res), file = "//nas1/XL2$/speciale/tables/fe_k50_all_all_deciles/eu_grad_k_all_w-INSTNR-all_ses_large_all_all.csv")
...
res <- summary(reg, vcov = ~INSTNR)
print(res)
write.csv(fe_res_table(res), file = "//nas1/XL2$/speciale/tables/fe_k50_all_all_deciles/gym_grad_k_all_w-INSTNR-all_ses_small_all_all.csv")
...
res <- summary(reg, vcov = ~INSTNR)
print(res)
write.csv(fe_res_table(res), file = "//nas1/XL2$/speciale/tables/fe_k50_all_all_deciles/gym_grad_k_all_w-INSTNR-all_ses_large_all_all.csv")
...
res <- summary(reg, vcov = ~INSTNR)
print(res)
write.csv(fe_res_table(res), file = "//nas1/XL2$/speciale/tables/fe_k50_all_all_deciles/us_grad_k_all_w-INSTNR-all_ses_small_all_all.csv")
...
res <- summary(reg, vcov = ~INSTNR)
print(res)
write.csv(fe_res_table(res), file = "//nas1/XL2$/speciale/tables/fe_k50_all_all_deciles/us_grad_k_all_w-INSTNR-all_ses_large_all_all.csv")
...
res <- summary(reg, vcov = ~INSTNR)
print(res)
write.csv(fe_res_table(res), file = "//nas1/XL2$/speciale/tables/fe_k50_all_all_deciles/real_neet_k_all_w-INSTNR-all_ses_small_all_all.csv")
...
res <- summary(reg, vcov = ~INSTNR)
print(res)
write.csv(fe_res_table(res), file = "//nas1/XL2$/speciale/tables/fe_k50_all_all_deciles/real_neet_k_all_w-INSTNR-all_ses_large_all_all.csv")
...
res <- summary(reg, vcov = ~INSTNR)
print(res)
write.csv(fe_res_table(res), file = "//nas1/XL2$/speciale/tables/fe_k50_all_all_deciles/eu_grad_k_all_nw-INSTNR-all_ses_small_all_all.csv")
...
res <- summary(reg, vcov = ~INSTNR)
print(res)
write.csv(fe_res_table(res), file = "//nas1/XL2$/speciale/tables/fe_k50_all_all_deciles/eu_grad_k_all_nw-INSTNR-all_ses_large_all_all.csv")
...
res <- summary(reg, vcov = ~INSTNR)
print(res)
write.csv(fe_res_table(res), file = "//nas1/XL2$/speciale/tables/fe_k50_all_all_deciles/gym_grad_k_all_nw-INSTNR-all_ses_small_all_all.csv")
...
res <- summary(reg, vcov = ~INSTNR)
print(res)
write.csv(fe_res_table(res), file = "//nas1/XL2$/speciale/tables/fe_k50_all_all_deciles/gym_grad_k_all_nw-INSTNR-all_ses_large_all_all.csv")
...
res <- summary(reg, vcov = ~INSTNR)
print(res)
write.csv(fe_res_table(res), file = "//nas1/XL2$/speciale/tables/fe_k50_all_all_deciles/us_grad_k_all_nw-INSTNR-all_ses_small_all_all.csv")
...
res <- summary(reg, vcov = ~INSTNR)
print(res)
write.csv(fe_res_table(res), file = "//nas1/XL2$/speciale/tables/fe_k50_all_all_deciles/us_grad_k_all_nw-INSTNR-all_ses_large_all_all.csv")
...
res <- summary(reg, vcov = ~INSTNR)
print(res)
write.csv(fe_res_table(res), file = "//nas1/XL2$/speciale/tables/fe_k50_all_all_deciles/real_neet_k_all_nw-INSTNR-all_ses_small_all_all.csv")
...
res <- summary(reg, vcov = ~INSTNR)
print(res)
write.csv(fe_res_table(res), file = "//nas1/XL2$/speciale/tables/fe_k50_all_all_deciles/real_neet_k_all_nw-INSTNR-all_ses_large_all_all.csv")
